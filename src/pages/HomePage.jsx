    ...
    <>
      <section className="flex flex-col gap-5">
        <div className="flex flex-col gap-2">
          <h2 className="text-lg text-gray-700">Popular Category</h2>
          <CategoryList
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-2xl font-semibold text-center">Discussions</h2>
          <ThreadList
      ...
      {authUser && (
        <Link to="/threads/add" className="fixed bottom-0 right-0 mb-20 mr-10">
